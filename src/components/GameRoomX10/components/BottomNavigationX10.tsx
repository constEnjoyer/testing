...
interface BottomNavigationX10Props {
...
/**
 * Компонент нижней навигации для игровой комнаты X10
 */
const BottomNavigationX10: React.FC<BottomNavigationX10Props> = ({ 
  activeScreen, 
  onNavigate,
  ...
  return (
    <nav className={styles.bottomNavigation}>
      <a 
        ...
        onClick={handleNavigation(ScreenType.HOME)}
      >
        <Image
...
export default BottomNavigationX10; 